...
public class Room_3 extends Fragment implements View.OnClickListener{

    private Thread connectionThread = null;
    private boolean once;
    String TAG = "Novita_Room_3";
    ...
    TextView sensor2;
    TextView sensor3;
    ImageView room3_iscon;

    LinearLayout room3_title;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.room_3, container, false);

        button_power = (Button) view.findViewById(R.id.button_room3_power);
        button_auto = (Button) view.findViewById(R.id.button_room3_toggle);

        sensor2 = (TextView) view.findViewById(R.id.room3_sensor2);
        sensor3 = (TextView) view.findViewById(R.id.room3_sensor3);
        room3_title = (LinearLayout) view.findViewById(R.id.room3_title);
        room3_iscon = (ImageView) view.findViewById(R.id.iscon_room3);
        ...
        room3_iscon.setOnClickListener(this);
        ...
        countDownTimer = new CountDownTimer(g_wait_time, 1000) {
            ...
            public void onFinish() {
                ...
                if(socket != null)
                    room3_iscon.setImageResource(R.drawable.connect);
                else
                    room3_iscon.setImageResource(R.drawable.disconnect);
            }
            @Override
    ...
    private Runnable showUpdate = new Runnable() {
        ...
        public void run() {
            ...
            if( readmsg != null )
            {
                ...
                room3_iscon.setImageResource(R.drawable.received);

                int color = 0;
                int pm25 = ((readmsg[5] & 0xFF) << 8) + (readmsg[6] & 0xFF);   // byte -> int
                int voc =  ((readmsg[7] & 0xFF) << 8) + (readmsg[8] & 0xFF);
